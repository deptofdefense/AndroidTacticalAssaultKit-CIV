...
if(WIN32)
    set(CMAKE_INSTALL_PREFIX ${CMAKE_SOURCE_DIR}/../takengine/build/jniLibs/win64)
elseif(ANDROID)
    set(CMAKE_INSTALL_PREFIX ${CMAKE_SOURCE_DIR}/../takengine/build/jniLibs/${ANDROID_ABI})
elseif(APPLE)
    set(CMAKE_INSTALL_PREFIX ${CMAKE_SOURCE_DIR}/../takengine/build/jniLibs/macos64)
elseif(UNIX)
    set(CMAKE_INSTALL_PREFIX ${CMAKE_SOURCE_DIR}/../takengine/build/jniLibs/linux64)
endif()
