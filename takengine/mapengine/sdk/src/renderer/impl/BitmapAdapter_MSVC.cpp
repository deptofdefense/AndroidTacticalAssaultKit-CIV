...
namespace
{
    ...
    TAKErr adaptImpl(BitmapPtr& value, Gdiplus::Bitmap& srcBitmap, const bool isRecurse) NOTHROWS;
}

TAKErr TAK::Engine::Renderer::Impl::BitmapAdapter_adapt(BitmapPtr &value, Gdiplus::Bitmap &srcBitmap) NOTHROWS
{
    if (srcBitmap.GetLastStatus() != Gdiplus::Status::Ok)
        return TE_InvalidArg;
    return adaptImpl(value, srcBitmap, false);
}
...
#define BITMAP_ADAPT_LIMIT 2048.0
        ...
        default:
            ...
            // recurse and return
            return adaptImpl(value, *argb, true);
        }
