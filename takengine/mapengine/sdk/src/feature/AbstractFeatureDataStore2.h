...
namespace TAK {
    namespace Engine {
        namespace Feature {
            ...
            public :
                virtual Util::TAKErr addOnDataStoreContentChangedListener(OnDataStoreContentChangedListener *l) NOTHROWS;
                virtual Util::TAKErr removeOnDataStoreContentChangedListener(OnDataStoreContentChangedListener *l) NOTHROWS;
                virtual Util::TAKErr getModificationFlags(int *value) NOTHROWS;
                virtual Util::TAKErr beginBulkModification() NOTHROWS;
                virtual Util::TAKErr endBulkModification(const bool successful) NOTHROWS;
                virtual Util::TAKErr isInBulkModification(bool *value) NOTHROWS;
                virtual Util::TAKErr insertFeatureSet(FeatureSetPtr_const *featureSet, const char *provider, const char *type, const char *name, const double minResolution, const double maxResolution) NOTHROWS;
                virtual Util::TAKErr updateFeatureSet(const int64_t fsid, const char *name) NOTHROWS;
                virtual Util::TAKErr updateFeatureSet(const int64_t fsid, const double minResolution, const double maxResolution) NOTHROWS;
                virtual Util::TAKErr updateFeatureSet(const int64_t fsid, const char *name, const double minResolution, const double maxResolution) NOTHROWS;
                virtual Util::TAKErr deleteFeatureSet(const int64_t fsid) NOTHROWS;
                virtual Util::TAKErr deleteAllFeatureSets() NOTHROWS;
                virtual Util::TAKErr insertFeature(FeaturePtr_const *feature, const int64_t fsid, const char *name, const atakmap::feature::Geometry &geom, const atakmap::feature::Style *style, const atakmap::util::AttributeSet &attributes) NOTHROWS;
                virtual Util::TAKErr updateFeature(const int64_t fid, const char *name) NOTHROWS;
                virtual Util::TAKErr updateFeature(const int64_t fid, const atakmap::feature::Geometry &geom) NOTHROWS;
                virtual Util::TAKErr updateFeature(const int64_t fid, const atakmap::feature::Style *style) NOTHROWS;
                virtual Util::TAKErr updateFeature(const int64_t fid, const atakmap::util::AttributeSet &attributes) NOTHROWS;
                virtual Util::TAKErr updateFeature(const int64_t fid, const char *name, const atakmap::feature::Geometry &geom, const atakmap::feature::Style *style, const atakmap::util::AttributeSet &attributes) NOTHROWS;
                virtual Util::TAKErr deleteFeature(const int64_t fid) NOTHROWS;
                virtual Util::TAKErr deleteAllFeatures(const int64_t fsid) NOTHROWS;
                virtual Util::TAKErr getVisibilitySettingsFlags(int *value) NOTHROWS;
                virtual Util::TAKErr setFeatureVisible(const int64_t fid, const bool visible) NOTHROWS;
                virtual Util::TAKErr setFeaturesVisible(const FeatureQueryParameters &params, const bool visible) NOTHROWS;
                virtual Util::TAKErr setFeatureSetVisible(const int64_t setId, const bool visible) NOTHROWS;
                virtual Util::TAKErr setFeatureSetsVisible(const FeatureSetQueryParameters &params, const bool visible) NOTHROWS;
            protected :
                ...
                virtual Util::TAKErr insertFeatureImpl(FeaturePtr_const *feature, const int64_t fsid, const char *name, const atakmap::feature::Geometry &geom, const atakmap::feature::Style *style, const atakmap::util::AttributeSet &attributes) NOTHROWS = 0;
            ...
            private :
                std::set<OnDataStoreContentChangedListener *> contentChangedListeners;
                int visibilityFlags;
                int modificationFlags;
                int inBulkModification;
                bool contentChanged;
            protected :
