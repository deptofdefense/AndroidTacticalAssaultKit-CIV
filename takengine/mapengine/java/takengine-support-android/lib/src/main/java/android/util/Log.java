...
//[CPL]import android.annotation.IntDef;
//[CPL]import android.annotation.NonNull;
//[CPL]import android.annotation.Nullable;
//[CPL]import android.compat.annotation.UnsupportedAppUsage;
//[CPL]import android.os.DeadSystemException;
//[CPL]import com.android.internal.os.RuntimeInit;
//[CPL]import com.android.internal.util.FastPrintWriter;
//[CPL]import com.android.internal.util.LineBreakBufferedWriter;
...
public final class Log {
    ...
    private static TerribleFailureHandler sWtfHandler = new TerribleFailureHandler() {
        public void onTerribleFailure(String tag, TerribleFailure what, boolean system) {
            //[CPL]RuntimeInit.wtf(tag, what, system);
        }
    };
    private Log() {
    }
    ...
    public static String getStackTraceString(@Nullable Throwable tr) {
        ...
        //[CPL]PrintWriter pw = new FastPrintWriter(sw, false, 256);
     ...
     */
    //[CPL]private static native int logger_entry_max_payload_native();
    ...
    public static int printlns(int bufID, int priority, @Nullable String tag, @NonNull String msg,
        ...
        //[CPL]int bufferSize = PreloadHolder.LOGGER_ENTRY_MAX_PAYLOAD    // Base.
        //[CPL]        - 2                                                // Two terminators.
        //[CPL]        - (tag != null ? tag.length() : 0)                 // Tag length.
        //[CPL]        - 32;                                              // Some slack.
        int bufferSize = 100;
        // At least assume you can print *some* characters (tag is not too large).
        bufferSize = Math.max(bufferSize, 100);
        //[CPL]LineBreakBufferedWriter lbbw = new LineBreakBufferedWriter(logWriter, bufferSize);
        PrintWriter lbbw = new PrintWriter(logWriter);
        lbbw.println(msg);
        if (tr != null) {
            // This is to reduce the amount of log spew that apps do in the non-error
            // condition of the network being unavailable.
            ...
            while (t != null) {
                ...
                //[CPL]if (t instanceof DeadSystemException) {
                //[CPL]    lbbw.println("DeadSystemException: The system died; "
                //[CPL]            + "earlier logs will point to the root cause");
                //[CPL]    break;
                //[CPL]}
                t = t.getCause();
            }
     ...
     */
    //[CPL]static class PreloadHolder {
    //[CPL]    public final static int LOGGER_ENTRY_MAX_PAYLOAD =
    //[CPL]            logger_entry_max_payload_native();
    //[CPL]}
    /**
