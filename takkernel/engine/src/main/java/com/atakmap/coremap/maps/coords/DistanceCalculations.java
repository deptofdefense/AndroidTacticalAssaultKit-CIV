...
public final class DistanceCalculations {
     ...
     *
     * @deprecated use {@link GeoCalculations#pointAtDistance(GeoPoint, double, double, double)}
     */
    @Deprecated
    @DeprecatedApi(since = "4.4", forRemoval = true, removeAt = "4.7")
    public static GeoPoint computeDestinationPoint(GeoPoint point, double a,
            double distance, double inclination) {
        return GeoCalculations.pointAtDistance(point, a, distance, inclination);
    }
     ...
     *
     * @deprecated use {@link GeoCalculations#pointAtDistance(GeoPoint, double, double)}
     * */
    @Deprecated
    @DeprecatedApi(since = "4.4", forRemoval = true, removeAt = "4.7")
    public static GeoPoint computeDestinationPoint(GeoPoint point, double a,
