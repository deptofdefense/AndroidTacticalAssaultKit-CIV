    ...
    namespace Engine {
        namespace Renderer {
            namespace Model {
                ...
                private:
                    static Util::TAKErr getShader(std::shared_ptr<const Renderer::Shader>& value, TAK::Engine::Core::RenderContext& ctx, const TAK::Engine::Model::VertexDataLayout& layout, GLMaterial& material, TAK::Engine::Model::DrawMode drawMode) NOTHROWS;
