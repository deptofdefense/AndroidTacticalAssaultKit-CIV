#ifndef TAK_ENGINE_FEATURE_FEATUREDATASTORELRUCACHELOGIC_H_INCLUDED
#define TAK_ENGINE_FEATURE_FEATUREDATASTORELRUCACHELOGIC_H_INCLUDED
...
namespace TAK {
    namespace Engine {
        namespace Feature {
            class ENGINE_API FeatureDataStoreLruCacheLogic : public FeatureDataStore2
            {
            public:
                FeatureDataStoreLruCacheLogic(FeatureDataStore2Ptr &&impl, const int cacheMaxItems) NOTHROWS;
                ~FeatureDataStoreLruCacheLogic() NOTHROWS;
            ...
            private:
                ...
                Thread::Mutex mutex;
                const std::unordered_map<int64_t, std::list<int64_t>::iterator>::size_type maxItems;
                std::unordered_map<int64_t, std::list<int64_t>::iterator> lruIterators;
