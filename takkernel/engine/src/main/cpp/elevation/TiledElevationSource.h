        ...
        public static TiledElevationSource createTerrainSource(String name,
            ...
            switch(scheme) {
                ...
                case Flat:
                    ...
                    min.tileWidth = 256;
                    min.tileHeight = 256;
                    bounds = new Envelope(-180d, -90d, 0d, 180d, 90d, 0d);
                    srid = 4326;
                    break;
                case FlatQuad:
                    min = new TileMatrix.ZoomLevel();
                    ...
                    min.tileWidth = 256;
                    min.tileHeight = 256;
                    bounds = new Envelope(-180d, -180d, 0d, 180d, 180d, 0d);
                    srid = 4326;
                    break;
                default :
            ...
            return new TiledElevationSource(name, srid, bounds, bounds.minX, bounds.maxY, scheme, levels, authoritative) {
                @Override
