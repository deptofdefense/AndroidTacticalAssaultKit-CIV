#ifndef ATAK_SSE2NEON_H
#define ATAK_SSE2NEON_H
...
#define vreinterpretq_f64_m128i(x) (float64x2_t)(x)
...
#if defined(__aarch64__)
#define vreinterpretq_m128d_s32(x) (float64x2_t)(x)
#define vreinterpretq_m128d_s64(x) (float64x2_t)(x)

#define vreinterpretq_m128d_u64(x) (float64x2_t)(x)

#define vreinterpretq_m128d_f32(x) (float64x2_t)(x)
#define vreinterpretq_m128d_f64(x) (x)

#define vreinterpretq_s64_m128d(x) (int64x2_t)(x)

#define vreinterpretq_u32_m128d(x) (uint32x4_t)(x)
#define vreinterpretq_u64_m128d(x) (uint64x2_t)(x)

#define vreinterpretq_f64_m128d(x) (x)
#define vreinterpretq_f32_m128d(x) float32x4_t(x)
#else
