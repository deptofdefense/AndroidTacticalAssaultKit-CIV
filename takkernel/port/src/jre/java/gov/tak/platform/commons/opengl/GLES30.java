...
public class GLES30 extends GLES20 implements GLES30Constants {
    ...
    public static void glInvalidateFramebuffer(
        ...
        int[] attachments,
        int offset
    ) {JOGLGLES.gl2.glInvalidateFramebuffer(target, numAttachments, attachments, offset);}
    // C function void glInvalidateFramebuffer ( GLenum target, GLsizei numAttachments, const GLenum *attachments )
    public static void glInvalidateFramebuffer(
        int target,
        int numAttachments,
        java.nio.IntBuffer attachments
    ) {JOGLGLES.gl2.glInvalidateFramebuffer(target, numAttachments, attachments);}
    ...
    public static void glInvalidateSubFramebuffer(
        ...
        int width,
        int height
    ) {JOGLGLES.gl2.glInvalidateSubFramebuffer(target, numAttachments, attachments, offset, x, y, width, height);}
    // C function void glInvalidateSubFramebuffer ( GLenum target, GLsizei numAttachments, const GLenum *attachments, GLint x, GLint y, GLsizei width, GLsizei height )
    public static void glInvalidateSubFramebuffer(
        int target,
        int numAttachments,
        ...
        int width,
        int height
    ) {JOGLGLES.gl2.glInvalidateSubFramebuffer(target, numAttachments, attachments, x, y, width, height);}
