...
public class GLES10 implements GLES10Constants {
    ...
    public static void glActiveTexture(int texture) {android.opengl.GLES20.glActiveTexture(texture);}

    // C function void glAlphaFunc ( GLenum func, GLclampf ref )

    public static void glAlphaFunc(int func, float ref) {android.opengl.GLES10.glAlphaFunc(func, ref);}
    ...
    public static void glColorPointer(int size, int type, int stride, java.nio.Buffer pointer) {android.opengl.GLES10.glColorPointer(size, type, stride, pointer);}
    ...
    public static void glNormalPointer(int type, int stride, java.nio.Buffer pointer) {android.opengl.GLES10.glNormalPointer(type, stride, pointer);}
    ...
    public static void glTexCoordPointer(int size, int type, int stride, java.nio.Buffer pointer) {android.opengl.GLES10.glTexCoordPointer(size, type, stride, pointer);}
    ...
    public static void glVertexPointer(int size, int type, int stride, java.nio.Buffer pointer) {android.opengl.GLES10.glVertexPointer(size, type, stride, pointer);}
