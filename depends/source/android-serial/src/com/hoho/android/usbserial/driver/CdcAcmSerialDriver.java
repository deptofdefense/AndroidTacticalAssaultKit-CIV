...
public class CdcAcmSerialDriver implements UsbSerialDriver {
    ...
    class CdcAcmSerialPort extends CommonUsbSerialPort {
        ...
        public CdcAcmSerialPort(UsbDevice device, int portNumber) {
            ...
            mEnableAsyncReads = (Build.VERSION.SDK_INT >= 17);
        }
        ...
        public void open(UsbDeviceConnection connection) throws IOException {
            ...
            try {
                ...
                //Log.d(TAG, "Control iface=" + mControlInterface + " " + mControlInterface.getName());
                ...
                //Log.d(TAG, "data iface=" + mDataInterface + " " + mDataInterface.getName());
                ...
                // Incorrect Endpoint assignment in CDC Driver (with fix) #112 
        ...
        private int sendAcmControlMessage(int request, int value, byte[] buf) {
            return mConnection.controlTransfer(
                    USB_RT_ACM, request, value, 0, buf,
                    buf != null ? buf.length : 0, 5000);
        }
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        supportedDevices.put(8432,
                new int[] {
                    8449,
                });
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_VARASCITE),
                new int[] {
                    UsbId.VERASCITE_ACM1,
                    UsbId.VERASCITE_ACM2,
                });
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_NAL_RESEARCH),
                new int[] {
                    UsbId.NAL_SERIAL,
                });
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_STUDER),
                new int[] {
                    UsbId.DAISY_RECEIVER,
                    UsbId.DAISY_RECEIVER2,
                });
        supportedDevices.put(Integer.valueOf(UsbId.VENDOR_MAYFLOWER),
                new int[] {
                    UsbId.MAYFLOWER_RECEIVER,
                });
