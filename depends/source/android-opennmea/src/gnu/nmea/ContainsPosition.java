...
/**
 * An interface for data packets that contain position information in
 ...
 * @since OpenNMEA v0.1
 */
public interface ContainsPosition
{
    /**
     * Returns the geographic position data stored in a packet
