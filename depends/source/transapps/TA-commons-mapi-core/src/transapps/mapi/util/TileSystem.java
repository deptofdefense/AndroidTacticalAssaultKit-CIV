...
public final class TileSystem {
    ...
    public static <T extends Coordinate> T PixelXYToLatLong(final int pixelX, final int pixelY,
            final int levelOfDetail, final T reuse) {
        final Coordinate out = (reuse == null ? new GeoPoint(0, 0) : reuse);
        ...
        out.setY((int) (latitude * 1E6));
        out.setX((int) (longitude * 1E6));
        return (T) out;
    }
