 ...
 * @deprecated in NW SDK 1.1.6.3 use {@link MapOverlay} instead
 */
public abstract class Overlay {
    ...
    /**
     * The shadow parameter is no longer used
     *
     * @deprecated use @Link  {@link draw(Canvas, MapView)} instead.
     */
    //@Deprecated
     ...
     * Callers should check isEnabled() before calling draw(). By default, draws nothing.
     */
     ...
     * find appropriate coordinates from latitude/longitude using the IMapView.getProjection() method
     * on the IMapView passed to you in draw(Canvas, IMapView, boolean).
     *
     * @param shadow
    ...
    public interface Snappable {
         ...
         * @param mapView
         *            The {@link MapView} that is requesting the snap. Use IMapView.getProjection()
