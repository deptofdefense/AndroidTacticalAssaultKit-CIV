    ...
    private class LabelRenderContext extends StyleRenderContext {
        ...
        public LabelRenderContext(GLMapView view) {
            ...
            if(GLLabelPointStyle.this.textSize > 0)
                this.text = GLText.getInstance(new MapTextFormat(Typeface.DEFAULT, (int)Math.ceil(GLLabelPointStyle.this.textSize)));
            else
                this.text = GLText.getInstance(AtakMapView.getDefaultTextFormat());
