...
final class AndroidQueryStatement implements QueryIface, SQLiteDatabase.CursorFactory {
    ...
    @Override
    public Cursor newCursor(SQLiteDatabase arg0, SQLiteCursorDriver arg1, String arg2, SQLiteQuery arg3) {
        for(int i = 0; i < this.args.length; i++)
    ...
    public boolean moveToNext() {
        if(this.impl == null)
            this.impl = new AndroidCursorAdapter(this.database.rawQueryWithFactory(this, this.sql, null, null));
