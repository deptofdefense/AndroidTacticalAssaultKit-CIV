        ...
        public synchronized Data createData() {
            if (this.data == null) {
                ...
                if ((aabb.maxX - aabb.minX) <= 180d) {
                    final double dx1 = DistanceCalculations.calculateRange(
                            new GeoPoint(bounds.getY(0), bounds.getY(0)),
                            new GeoPoint(bounds.getY(1), bounds.getY(1)));
                    final double dx2 = DistanceCalculations.calculateRange(
                            new GeoPoint(bounds.getY(2), bounds.getY(2)),
                            new GeoPoint(bounds.getY(3), bounds.getY(3)));
                    final double dy1 = DistanceCalculations.calculateRange(
                            new GeoPoint(bounds.getY(1), bounds.getY(1)),
                            new GeoPoint(bounds.getY(2), bounds.getY(2)));
                    final double dy2 = DistanceCalculations.calculateRange(
                            new GeoPoint(bounds.getY(3), bounds.getY(3)),
                            new GeoPoint(bounds.getY(0), bounds.getY(0)));
