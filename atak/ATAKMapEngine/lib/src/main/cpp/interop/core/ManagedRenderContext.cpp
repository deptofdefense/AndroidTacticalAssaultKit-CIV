...
#define SET_METHOD_DEFINITION(c, m, sig) \
    c.m = env.GetMethodID(c.id, #m, sig)
        ...
        RenderContext_class.id = ATAKMapEngineJNI_findClass(&env, "com/atakmap/map/RenderContext");
        ...
        SET_METHOD_DEFINITION(RenderContext_class, createChildContext, "()Lcom/atakmap/map/RenderContext;");
        SET_METHOD_DEFINITION(RenderContext_class, destroyChildContext, "(Lcom/atakmap/map/RenderContext;)V");
        ...
        SET_METHOD_DEFINITION(RenderContext_class, getRenderSurface, "()Lcom/atakmap/map/RenderSurface;");
