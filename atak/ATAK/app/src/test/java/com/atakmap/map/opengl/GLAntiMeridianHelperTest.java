...
public class GLAntiMeridianHelperTest {
    ...
    public void unwrapped_west_hemi_does_not_cross() {
        ...
        final DoubleBuffer src = DoubleBuffer.wrap(new double[] {a.getLongitude(), a.getLatitude(), b.getLongitude(), b.getLatitude()});
        final DoubleBuffer dst = DoubleBuffer.allocate(src.capacity());

        final int result = GLAntiMeridianHelper.normalizeHemisphere(2, src, dst);
        assertEquals(0, result&GLAntiMeridianHelper.MASK_IDL_CROSS);
        assertEquals(GLAntiMeridianHelper.HEMISPHERE_WEST, result&GLAntiMeridianHelper.MASK_PRIMARY_HEMISPHERE);
    }
    ...
    public void unwrapped_east_hemi_does_not_cross() {
        ...
        final int result = GLAntiMeridianHelper.normalizeHemisphere(2, src, dst);
        assertEquals(0, result&GLAntiMeridianHelper.MASK_IDL_CROSS);
        assertEquals(GLAntiMeridianHelper.HEMISPHERE_EAST, result&GLAntiMeridianHelper.MASK_PRIMARY_HEMISPHERE);
    }
    ...
    public void west_cross_to_east_cross_to_west() {
        ...
        final DoubleBuffer src = DoubleBuffer.wrap(new double[] {a.getLongitude(), a.getLatitude(), b.getLongitude(), b.getLatitude(), c.getLongitude(), c.getLatitude()});
        final DoubleBuffer dst = DoubleBuffer.allocate(src.capacity());
