 ...
 * Adapt icon based on CoT/2525B symbols
 * 
 * 
 */
public class Icon2525bIconAdapter implements IconAdapter {
    ...
    // that still perform the work on 2525b markers
     ...
     * @param adapter the custom adapter which would further augment  the current 2525b 
     * capability.
     */
    ...
    public boolean adapt(final Marker marker) {
        return adapt2525bMarkerIcon(marker);
    }
     ...
     */
    boolean adapt2525bMarkerIcon(final Marker marker) {
    ...
    private String _findAssetPath(final String cotType) {
        String r = null;
        String type2525 = Icon2525bTypeResolver.mil2525bFromCotType(cotType);
        String fileName = "mil-std-2525b/" + type2525 + ".png";
