...
public class Icon2525bPalletFragment extends Fragment {

    private static final String TAG = "Icon2525bPalletFragment";
     ...
     * as an argument.
     */
    public static Icon2525bPalletFragment newInstance(UserIconSet iconset) {
        Icon2525bPalletFragment f = new Icon2525bPalletFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.enter_location_2525b, container,
                false);
    ...
    Marker getPointPlacedIntent(final GeoPointMetaData p, final String uid)
        ...
        if (_currType == null) {
            ...
            String iconsetPath = UserIcon.GetIconsetPath(
                    Icon2525bPallet.COT_MAPPING_2525B, _currType, type);
